...
<html>
    <head>
        ...
        <link rel="stylesheet" href="./css/user/News_1.css">
        <link rel="stylesheet" href="./css/user/News_boostrap.css">
        <link rel="stylesheet" href="./css/user/News_font.css">
        <link rel="stylesheet" href="./css/user/News_responsive.css">
        <link rel="stylesheet" href="./css/user/News_styles.css">
        ...
        <jsp:include page="../../layouts/user/BoxChat.jsp"></jsp:include>
            ...
            <section class="aboutUs">
                ...
                <%  for (News news : newsList) {
                        NewsDetail newsdetail = NewsDao.getNewsDetail(news.getNewsID());
                        NewsDetail lastestNews = NewsDao.getLastestNews();
                        if (newsdetail.getNewsID().equals(lastestNews.getNewsID())) {
                %>             
                        ...
                        <div class="masonry-blog clearfix">
                            <div class="first-slot">
                                <div class="masonry-box post-media">
                                    <img src="<%= news.getImagePath()%>" alt="" class="img-fluid">
                                    <div class="shadoweffect">
                                        <div class="shadow-desc">
                                            <div class="blog-meta">
                                                <h4><a href="${pageContext.request.contextPath}/NewsDetail?newsID=<%= news.getNewsID()%>" title=""><%= news.getNameOfnews()%></a></h4>
                                                <small><a href="${pageContext.request.contextPath}/NewsDetail?newsID=<%= news.getNewsID()%>" title=""><%= newsdetail.getPostDate()%></a></small>
                                                <small><a href="${pageContext.request.contextPath}/NewsDetail?newsID=<%= news.getNewsID()%>" title="">by Amanda</a></small>
                                            </div><!-- end meta -->
                                        </div><!-- end shadow-desc -->
                                    </div><!-- end shadow -->
                                </div><!-- end post-media -->
                                        ...
                                        <div class="blog-box row">
                                            <div class="col-md-4">
                                                <div class="post-media">
                                                    <a href="${pageContext.request.contextPath}/NewsDetail?newsID=<%= news.getNewsID()%>" title="">
                                                        <img src="<%= news.getImagePath()%>" alt="" class="img-fluid">
                                            ...
                                            <div class="blog-meta big-meta col-md-8">
                                                <h2><a href="${pageContext.request.contextPath}/NewsDetail?newsID=<%= news.getNewsID()%>" title="" style="position: relative; color: rgba(118, 183, 243, 1); background-color: white""><%= news.getNameOfnews()%></a></h2>
                                                <p><%= newsdetail.getNewsContent().substring(0, 200) %>...</p>
                                                <small class="firstsmall"><a class="bg-orange" href="${pageContext.request.contextPath}/NewsDetail?newsID=<%= news.getNewsID()%>" title="">Gadgets</a></small>
                                                <small><a href="${pageContext.request.contextPath}/NewsDetail?newsID=<%= news.getNewsID()%>" title=""><%= newsdetail.getPostDate()%></a></small>
                                                <small><a href="${pageContext.request.contextPath}/NewsDetail?newsID=<%= news.getNewsID()%>" title=""><%= newsdetail.getPorter()%></a></small>
                                                <small><a href="${pageContext.request.contextPath}/NewsDetail?newsID=<%= news.getNewsID()%>" title=""><i class="fa fa-eye"></i><%= newsdetail.getNumberOfViews() %></a></small>
                                            </div><!-- end meta -->
                                        </div><!-- end blog-box -->
                                        <hr class="invis">
                                    </div><!-- end blog-list -->          
