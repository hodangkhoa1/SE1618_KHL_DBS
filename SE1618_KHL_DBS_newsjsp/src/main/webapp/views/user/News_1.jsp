                ...
                <div class="about__keep">
                    <div class="container">
                        <div class="row news_keep align-items-center">
                            <div class="col-12 col-xl-6 mb-5 mb-xl-0"><a href="${pageContext.request.contextPath}/NewsDetail?newsID=<%= news.getNewsID()%>" data-wpel-link="internal"/>
                                <div class="about__keep--content">
                                    <h1 style="color: rgba(118, 183, 243, 1)"><%= news.getNameOfnews()%></h1>
                                    <div class="desc">
                                        <p><%= news.getNewsContenShort()%></p>
                                    </div>
                                    <div class="btn--link">
                                        <a class="about-btn-link" href="${pageContext.request.contextPath}/NewsDetail?newsID=<%= news.getNewsID()%>" >View more</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-xl-6">
                                <div class="about__keep--img">
                                    <img src="<%= news.getImagePath()%>" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="about__keep">
                    <div class="container"> 
                        <div class="row news_keep align-items-center">
                            ...
                            <div class="col-12 col-xl-8 mb-5 mb-xl-0"><a href="${pageContext.request.contextPath}/NewsDetail?newsID=<%= news.getNewsID()%>" data-wpel-link="internal"/>
                                <div class="about__keep--content">
                                    <h3 ><%= news.getNameOfnews()%></h3>
                                    <div class="desc">
                                        <p><%= news.getNewsContenShort()%></p>
                                    </div>
                                    <div class="btn--link">
