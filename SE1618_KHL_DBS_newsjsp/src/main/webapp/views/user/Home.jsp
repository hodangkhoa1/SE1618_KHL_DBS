<%@page import="com.khl.gentledentalcare.models.Dentist"%>
        ...
        <jsp:include page="../../layouts/user/BoxChat.jsp"></jsp:include>
            ...
            <section class="doctorTeam">
                ...
                <div class="container doctor__list">
                    ...
                    <%
                        ArrayList<Dentist> dentistList = (ArrayList<Dentist>) request.getAttribute("dentistList");
                        for (Dentist dentist : dentistList) {
                    %>  
                    <div class="col-12 col-lg-4 d-flex justify-content-center">
                        <div class="card my-3"> 
                            <img src="<%= dentist.getImageDentist()%>" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h6><%= dentist.getAcademicRank()%></h6>
                                <%= dentist.getNameDentist()%>
                                <%= dentist.getDentistDescription()%>
                                ...
                                <div class="btn--link">
                                    <a class="about-btn-link" href="${pageContext.request.contextPath}/DentistInformation?DentistID=<%= dentist.getDentistID()%>">View more</a>
                                </div>
                        </div>
                    </div>
                    <%
