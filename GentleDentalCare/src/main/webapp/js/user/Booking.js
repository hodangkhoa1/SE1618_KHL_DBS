...
function addLi() {
    ...
    if (checkToday() === 1) {
        document.getElementById("slotCatchQ").innerHTML = "Please choose another date";
        return;
    }
            ...
            if (document.getElementById('date' + i) !== null || document.getElementById('lot' + i) !== null || document.getElementById('service' + i) !== null) {
                if (getDate() === document.getElementById('date' + i).value) {
                    ...
                    if (getValueId() === document.getElementById('service' + i).value) {
                        document.getElementById('slotCatchQ').innerHTML = "Please choose another service";
                        return;
                    } else if (getSlotValue() === document.getElementById('lot' + i).value) {
                        document.getElementById('slotCatchQ').innerHTML = "Please choose another slot";
                        return;
                    }
                }
            }
    ...
    if (countDay[getDate()] > 2) {
        dateArray.pop();
        document.getElementById('slotCatchQ').innerHTML = "Only can choose 2 service per day";
        return;
    }
