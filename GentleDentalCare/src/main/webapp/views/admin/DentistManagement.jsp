...
<html>
    <head>
        ...
        <title>Dentist Management | Page: ${CURRENT_PAGE}</title>
        <!-- Favicon icon -->
        ...
        <section id="content">
            ...
            <main class="main">
                ...
                <ul class="breadcrumbs">
                    ...
                    <li class="divider">/</li>
                    <li><a href="${pageContext.request.contextPath}/admin/dentist-management" class="active">Dentist Management</a></li>
                </ul>
