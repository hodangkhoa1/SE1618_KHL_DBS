...
public class DentistDetailController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            String dentistDetail = request.getParameter("dd");

            if (dentistDetail != null) {
                DentistFacade dentistFacade = new DentistFacade();
                Dentist dentist = dentistFacade.getDentistDetail(dentistDetail);

                request.setAttribute(DENTIST_DETAIL, dentist);
                RequestDispatcher requestDispatcher = this.getServletContext().getRequestDispatcher("/views/user/DentisDetail.jsp");
