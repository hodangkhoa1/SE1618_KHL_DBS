...
<html>
    <head>
        ...
        <title>News Management | Page: ${CURRENT_PAGE}</title>
        <!-- Favicon icon -->
        ...
        <link href=".././css/admin/NewsManagement.css" rel="stylesheet" type="text/css"/>
    ...
    <body ng-app="myapp" ng-controller="viewCril">
        ...
        <section id="content">
            ...
            <main class="main">
                ...
                <ul class="breadcrumbs">
                    ...
                    <li class="divider">/</li>
                    <li><a href="${pageContext.request.contextPath}/admin/news-management" class="active">News Management</a></li>
                </ul>
                ...
                <div class="management-button">
                    ...
                    <button onclick="window.location.href='${pageContext.request.contextPath}/admin/add-news'" type="button" class="button-export button-add">
                        <i class="fa-solid fa-user-plus"></i>Add News
                    </button>
                </div>
                ...
                <div class="table-users" id="tableToExport">
                    <table cellspacing="0">
                        ...
                        <tr ng-repeat="news in listNews | filter: ${SEARCH}">
                            <td>{{$index + 1}}</td>
                            <td>{{news.nameOfNews}}</td>
                        ...
                        <ul>
                            <c:if test="${CURRENT_PAGE > 1}">
                                <li class="pagination-button button-prev">
                                    <a href="${pageContext.request.contextPath}/admin/news-management?page=${CURRENT_PAGE - 1}">
                            ...
                            <c:forEach begin="1" end="${END_PAGE}" var="i">
                                <li class="pagination-number ${CURRENT_PAGE == i ? "active" : ""}">
                                    <a href="${pageContext.request.contextPath}/admin/news-management?page=${i}" class="pagination-link">${i}</a>
                                </li>
                            </c:forEach>
        ...
        <script>
            ManageNewsAPI("${pageContext.request.contextPath}/admin/news-management", ${NEWS_LIST});
            activeSidebarLink();
        </script>
    </body>
</html>
