...
<html>
    <head>
        ...
        <title>${SERVICE_DETAIL.serviceName}</title>
                            ...
                            <div class="widget">
                                ...
                                <div class="blog-list-widget">
                                    <div class="list-group">
                                        <c:forEach items="${TOP_SERVICE}" var="service">
                                            <a href="${pageContext.request.contextPath}/service-detail?sid=${service.serviceID}" class="list-group-item list-group-item-action flex-column align-items-start">
                                                <div class="w-100 justify-content-between">
                                                    <img src="data:image/png;base64,${service.imageService}" alt="" class="img-fluid float-left">
                                                    <h5 class="mb-1">${service.serviceName}</h5>
                                                    <small><fmt:formatDate value="${service.serviceCreated}" pattern="dd-MM-yyyy"/></small>
                                                </div>
                                            </a>
                                        </c:forEach>
                                    </div>
